...
window.addEventListener("load", function () {
    ...
    // Noul cod (cu verificare)
     const sidebarToggleBtn = document.querySelector("button.sidebar-toggle-btn");
     if  (sidebarToggleBtn) { // Verifică dacă butonul există pe pagina curentă
